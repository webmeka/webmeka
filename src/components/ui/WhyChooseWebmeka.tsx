...
export function WhyChooseWebmeka() {
  const features = [
    {
      ...
      description:
        "We blend strategy and design to make your brand stand out, with purpose and clarity.",
  ...
  return (
    <section id="WhyWebmeka" aria-label="Webmeka why choose us section" className="relative z-10 py-10 max-w-7xl mx-auto w-full px-5 md:px-10 lg:px-20">
  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-medium mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-700 group-hover/feature:bg-cyan-400 transition-all duration-200 origin-center" />
        <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block font-medium text-xl text-neutral-100">
          {title}
        </span>
      </div>
      <p className="text-neutral-300 max-w-xs relative z-10 px-10">
        {description}
      </p>
    </div>
  );
