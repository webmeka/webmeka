    ...
    >
      ...
      <div className="mb-10">
        ...
        <ul className="list-disc list-inside text-neutral-300 space-y-1 mb-4">
          <li>Email address provided via forms</li>
          <li>First name provided via forms</li>
        ...
        <p className="text-neutral-300">
          We may collect information about how the Service is accessed and used, browser type, pages visited, time and date, and unique device identifiers(Mobile/desktop).
        </p>
      </div>
      ...
      <div className="mb-10">
        ...
        <p className="text-neutral-300 mb-2">
          Personal Data is retained only as long as necessary for the purposes described. Usage Data is generally retained for shorter periods unless required for security purposes.
        </p>
        <p className="text-neutral-300">
          <strong>Data Retention:</strong> For orders and project placed directly with us, project details and billing information is retained as necessary for order fulfillment.
        </p>
      </div>
      ...
      <div className="mb-10">
        ...
        <p className="text-neutral-300 mb-2">
          Your information may be transferred to and maintained on computers outside your jurisdiction. By using the Service, you consent to this transfer.
        </p>
        <p className="text-neutral-300">
      ...
      <div className="mb-10">
        ...
        <p className="text-neutral-300 mb-2"><strong>Payments:</strong> Payment processing is handled by third-party processors like PayPal, M-Pesa, or Stripe. We do not store your card details.</p>
      </div>
      ...
      <div className="mb-10">
        <h3 className="text-xl font-semibold mb-3 text-neutral-200">11. Your Data Protection Rights</h3>
        <ul className="list-disc list-inside text-neutral-300 space-y-1">
      ...
      <div className="mb-10">
        <h3 className="text-xl font-semibold mb-3 text-neutral-200">12. Service Providers</h3>
        <p className="text-neutral-300">
      ...
      <div className="mb-10">
        <h3 className="text-xl font-semibold mb-3 text-neutral-200">13. Links to Other Sites</h3>
        <p className="text-neutral-300">
      ...
      <div className="mb-10">
        <h3 className="text-xl font-semibold mb-3 text-neutral-200">14. Changes to This Privacy Policy</h3>
        <p className="text-neutral-300">
      ...
      <div className="mb-10">
        <h3 className="text-xl font-semibold mb-3 text-neutral-200">15. Contact Us</h3>
